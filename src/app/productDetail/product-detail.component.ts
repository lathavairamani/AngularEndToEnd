...
@Component({
 ...
 export class ProductDetailComponent implements OnInit {
    ...
    constructor( private route: ActivatedRoute, private router: Router, private shoppingCartService: ShoppingCartService ) {}
    ...
    getSingle(id: string){
        ...
        dbRef.orderByChild('id')
            ...
            .then((snapshot)=>{
                ...
                this.singleProduct = new Product (name,description,imgTitle, img, price, id);
            });  
    };
              
    addProduct(id: string, name: string, price: number) {
        this.shoppingCartService.addProduct(id, name, price);
    }
